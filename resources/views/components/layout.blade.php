    ...
    <nav class="md:flex md:justify-between md:items-center">
        ...
        <div class="mt-8 md:mt-0 flex items-center">
            @auth
                <x-dropdown>
                    <x-slot name="trigger">
                        <button class="text-xs font-bold uppercase w-full lg:w-32">Welcome, {{ auth()->user()->name }}!</button>
                    </x-slot>
                ...
                <form id="logout-form" method="POST" action="/logout" class="text-s font-semibold text-blue-500 ml-6">
                    @csrf
                </form>
            @else
